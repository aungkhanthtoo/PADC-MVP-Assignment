...
//                }));
        ...
        mPresenter.onLoadNewsDetails(newsId);
    }

    @Override
    public void showNewsDetail(NewsVO news) {
        tvNewsDetails.setText(news.getDetails());
    }

    @Override
    public void showErrorMsg(String msg) {
        Snackbar.make(tvNewsDetails, msg, Snackbar.LENGTH_INDEFINITE).show();
        tvNewsDetails.setText(msg);
    }
}
