...
public class NewsModel {
    ...
    public void startLoadingMMNews(@NonNull PublishSubject<List<NewsVO>> subject) {
        ...
        newsResponseObservable
                ...
                .map(new Function<GetNewsResponse, List<NewsVO>>() {
                    @Override
                    public List<NewsVO> apply(GetNewsResponse newsResponse) throws Exception {
                        return newsResponse.getNewsList();
                    }
                })
    ...
    */
    ...
    private void saveBulkData(@NonNull List<NewsVO> newList) {
        ...
        Log.d("INSERTED", "favorites : " + favorites.length);
